...
$(document).ready(function(){$(".card").on("click",function(){$(this).find(".card__overlay").toggleClass("card__overlay--hidden")}).find(".card__overlay__content").on("click",function(t){t.stopPropagation()}),$(".card__overlay__section--like,\n  .card__overlay__section--dislike").on("click",function(){rated=$(this).hasClass("js-rated"),$(this).toggleClass("js-rated"),stat=$(this).find(".card__overlay__social-stat"),rating=parseInt(stat.text()),rated?rating--:rating++,stat.text(rating),$(this).toggleClass("card__overlay__social-stat--active"),$(this).closest(".card__overlay").delay(250).queue(function(){$(this).addClass("card__overlay--hidden"),$(this).dequeue()})})});
