...
$(document).ready(function(){$(".card").on("click",function(){$(this).find(".card__overlay").toggleClass("card__overlay--hidden")}).find(".card__overlay__content").on("click",function(t){t.stopPropagation()}),$(".card__overlay__section--like,\n  .card__overlay__section--dislike").on("click",function(){if(rated=$(this).hasClass("js-rated"),$(this).toggleClass("js-rated"),$(this).toggleClass("card__overlay__social-stat--active"),stat=$(this).find(".card__overlay__social-stat"),rating=parseInt(stat.text()),rated){rating--;{new fries.Toast({content:"Removed sentiment from content."})}}else{rating++;{new fries.Toast({content:"Added sentiment to content."})}}stat.text(rating),$(this).closest(".card__overlay").delay(250).queue(function(){$(this).addClass("card__overlay--hidden"),$(this).dequeue()})})});
