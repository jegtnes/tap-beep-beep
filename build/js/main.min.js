...
$(document).ready(function(){if($("#tapInToBegin, #tapInExplanation").on("click",function(){$("#tapInExplanation").toggleClass("explanation-hidden")}),$(".action-overflow-hidden").removeClass("action-overflow-hidden"),query=$.parseQuery(),"photo"===query.upload){new fries.Toast({content:"Thanks! Your photo will be uploaded shortly."})}else if("text"===query.upload){new fries.Toast({content:"Thanks! Your post will be uploaded shortly."})}});
