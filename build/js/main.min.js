...
$(function(){hammertime=Hammer(document.body,{swipeVelocityX:.2}).on("dragright, swiperight",function(){$(".main-navigation").addClass("main-navigation--open")}),hammertime=Hammer(document.body,{swipeVelocityX:.2}).on("dragleft, swipeleft",function(){$(".main-navigation").removeClass("main-navigation--open")}),Hammer($(".app-icon")[0]).on("tap",function(){$(".main-navigation").toggleClass("main-navigation--open")})});