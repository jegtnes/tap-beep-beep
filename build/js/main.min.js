...
$(document).ready(function(){$("#map").length&&(map=new GMaps({div:"#map",lat:51.49994,lng:-2.547272}),map.addMarker({lat:51.501629,lng:-2.548818,icon:"/build/img/map-marker-tappoint.png",title:"Cribs Q",infoWindow:{content:"<p>Cribs Q</p>"}}),map.addMarker({lat:51.501285,lng:-2.548807,icon:"/build/img/map-marker-tappoint.png",title:"Q Block Info Point",infoWindow:{content:"<p>Q Block Info Point</p>"}}),map.addMarker({lat:51.50112,lng:-2.548608,icon:"/build/img/map-marker-tappoint.png",title:"Q Block Pond",infoWindow:{content:"<p>Q Block Pond</p>"}}),map.addMarker({lat:51.500395,lng:-2.548038,icon:"/build/img/map-marker-tappoint.png",title:"Full Of Beans",infoWindow:{content:"<p>Full Of Beans</p>"}}),GMaps.geolocate({success:function(o){map.setCenter(o.coords.latitude,o.coords.longitude),map.addMarker({lat:o.coords.latitude,lng:o.coords.longitude,icon:"/build/img/map-marker-geolocation.png",title:"You are here.",infoWindow:{content:"<p>You are here!</p>"}})},error:function(o){console.log("Geolocation failed: "+o.message)},not_supported:function(){console.log("Your browser has no geolocation")}}))});
