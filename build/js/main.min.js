...
$(document).ready(function(){$("#map").length&&(map=new GMaps({div:"#map",lat:51.49994,lng:-2.547272}),map.addMarker({lat:51.501629,lng:-2.548818,icon:"/build/img/map-marker-tappoint.png",title:"Cribs Q",infoWindow:{content:"<p>Cribs Q</p>"}}),map.addMarker({lat:51.501285,lng:-2.548807,icon:"/build/img/map-marker-tappoint.png",title:"Q Block Info Point",infoWindow:{content:"<p>Q Block Info Point</p>"}}),map.addMarker({lat:51.50112,lng:-2.548608,icon:"/build/img/map-marker-tappoint.png",title:"Q Block Pond",infoWindow:{content:"<p>Q Block Pond</p>"}}),map.addMarker({lat:51.500395,lng:-2.548038,icon:"/build/img/map-marker-tappoint.png",title:"Full Of Beans",infoWindow:{content:"<p>Full Of Beans</p>"}}),map.addMarker({lat:51.500395,lng:-2.548038,icon:"/build/img/map-marker-tappoint.png",title:"Jimmy Deane's Fruit & Veg",infoWindow:{content:"<p>Jimmy Deane's Fruit &amp; Veg</p>"}}),map.addMarker({lat:51.5002,lng:-2.547376,icon:"/build/img/map-marker-tappoint.png",title:"The SU Shop",infoWindow:{content:"<p>The SU Shop</p>"}}),map.addMarker({lat:51.500061,lng:-2.547478,icon:"/build/img/map-marker-tappoint.png",title:"Escape Bar",infoWindow:{content:"<p>Escape Bar</p>"}}),map.addMarker({lat:51.500049,lng:-2.547588,icon:"/build/img/map-marker-tappoint.png",title:"Red Bar",infoWindow:{content:"<p>Red Bar</p>"}}),GMaps.geolocate({success:function(n){map.setCenter(n.coords.latitude,n.coords.longitude),map.addMarker({lat:n.coords.latitude,lng:n.coords.longitude,icon:"/build/img/map-marker-geolocation.png",title:"You are here.",infoWindow:{content:"<p>You are here!</p>"}})},error:function(n){console.log("Geolocation failed: "+n.message)},not_supported:function(){console.log("Your browser has no geolocation")}}))});
